    ...
    <div class="container">
      <div class="page input js_show">
        ...
        <div class="page__hd" style="padding: 20px 20px 0 20px;">
          <h1 class="page__title"><!-- <input type="text" readonly="readonly" id="task_status" name="task_status"> --><span id="task_status" name="task_status"></span><span id="task_name" class="task_name_c" name="task_name">蜂巢项目（hivebanks）中文版白皮书</span><input type="text" class="level" name="task_level" id="task_level" value="⭐⭐⭐" readonly="readonly"></h1>
